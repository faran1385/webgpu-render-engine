...
export class ModelAnimator {
    ...
    public update(animation: Animation, time: number, mode: "loop" | "backAndForth" | undefined = undefined, nodeMap: Map<Node, SceneObject>) {
        ...
        for (const channel of channels) {
            ...
            if (path === 'translation') targetSceneObject.setTranslation(targetSceneObject.animationMatrix,value as any);
            else if (path === 'rotation') targetSceneObject.setRotation(targetSceneObject.animationMatrix,value as any);
            else if (path === 'scale') targetSceneObject.setScale(targetSceneObject.animationMatrix,value as any);
